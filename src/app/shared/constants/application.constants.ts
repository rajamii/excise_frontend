...
export const WORKFLOW_IDS = {
    ...
    [APPLICATION_TYPES.SPECIAL_PERMIT]: 0 // View-only detail flow
} as const;
...
export const APPLICATION_TITLES = {
    ...
    [APPLICATION_TYPES.SPECIAL_PERMIT]: 'SPECIAL PERMIT APPLICATION'
} as const;
...
export const PAGE_TITLES = {
    ...
    [APPLICATION_TYPES.SPECIAL_PERMIT]: 'Special Permit Details'
} as const;
