...
@Component({
  selector: 'app-edit', // Component selector
  imports: [MaterialModule], // Import necessary Material module
  templateUrl: './edit.component.html', // HTML template for the component
  styleUrl: './edit.component.scss' // Styles for the component
})
export class EditComponent extends BaseComponent implements OnInit{
  ...
  onSave(): void {
    ...
    this.adminService.updateSubDivision(this.data.id, updatedData).subscribe(
      () => {
