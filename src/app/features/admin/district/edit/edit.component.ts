...
@Component({
  ...
  templateUrl: './edit.component.html', // Template file
  styleUrl: './edit.component.scss'     // Styling file
})
export class EditComponent extends BaseComponent{
  ...
  constructor(
    deps: BaseDependency,
    public dialogRef: MatDialogRef<EditComponent>, // Used to close the dialog and return data
