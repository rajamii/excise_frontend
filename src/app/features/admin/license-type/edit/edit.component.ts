...
@Component({
  selector: 'app-edit',  // The component's selector
  imports: [MaterialModule],  // Material modules needed for the component
  templateUrl: './edit.component.html',  // Template for the component
  styleUrl: './edit.component.scss'  // Styling for the component
})
export class EditComponent extends BaseComponent{
  ...
  constructor(
    deps: BaseDependency,
    public dialogRef: MatDialogRef<EditComponent>,  // Reference to the dialog for closing it
