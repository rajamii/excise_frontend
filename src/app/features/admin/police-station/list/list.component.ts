...
@Component({
  ...
  templateUrl: './list.component.html', // Component template URL
  styleUrl: './list.component.scss' // Component styles URL
})
export class ListComponent extends BaseComponent implements OnInit{
  ...
  // Dialog form to add a new police station
  onAdd(): void {
    ...
    dialogRef.afterClosed().subscribe(result => {
      if (result === true) {
        this.loadPoliceStations();  // Reload after adding
      }
    });
  }
