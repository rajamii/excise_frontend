export const environment = {
    ...
    payment: {
        ...
        callbackUrl: 'https://sems.sikkim.gov.in:8443/transactional/payment-gateway/billdesk/response/',
        // callbackUrl: 'http://127.0.0.1:8000/transactional/payment-gateway/billdesk/response/',

        cancelUrl: 'https://sems.sikkim.gov.in:8443/transactional/payment-gateway/billdesk/response/',
